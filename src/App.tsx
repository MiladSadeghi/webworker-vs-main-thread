    ...
    <div className="h-screen bg-slate-950 text-slate-100 flex flex-col font-sans overflow-hidden">
      ...
      <main className="grow min-h-0 grid grid-cols-1 lg:grid-cols-12 gap-5 p-5 w-full mx-auto overflow-hidden">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4 min-h-0 overflow-y-auto pr-1">
          ...
          <div className="mt-2 flex items-center justify-center gap-4 text-sm text-slate-500 border-t border-slate-900/60 pt-4 shrink-0 font-sans">
            <a
              href="https://github.com/MiladSadeghi/webworker-vs-main-thread"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/milad-sadeghi-503a332b1/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 hover:text-slate-300 transition-colors"
            >
              <svg className="h-4 w-4 fill-current text-sky-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
